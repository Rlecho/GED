...
?>
        <section class="main">
            ...
            <h1>Recherche par dossiers :</h1>
            <br>
            <form action="" method="post" >
                <input type="hidden" name="action" value="searchByClass" />
                <select class="large" name="category" style="height: 50px; width: 200px;">
            ...
            <br><br>
            <h1>Rechercher par mot clé (fichier) :</h1>
            <br>
            <form action="" method="post">
                ...
                <datalist id="fliensNames" style="height: 50px; width: 200px;"  >
